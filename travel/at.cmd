...
echo
echo * * *
echo * * * Astral Travel script by Foresee, edited by Uversy, Mozzik, Coralin, and Randoon
echo * * * Last edited: 4/28/2017
echo * * * Edited by: Shohanna
echo * * * Version 3.7.1 for DR 3.0
echo * * *
...
setCounter1:
echo * * * Mana, second variable, was specified.
setvariable myCounter %2
goto setMana

setCounter2:
echo * * * Mana, second variable, was not specified.
...
setMana1:
echo * * * Third variable was specified.
setvariable mana %3
goto myStart

setMana2:
echo * * * Third variable was not specified.
setvariable mana 15
goto myStart

myStart:
echo * * * Axis statistic variables are initialized.
setvariable stepsToAxis 0
setvariable stepsFromAxis 0

# These four variables are defined later in the script.
echo * * * Start, Destination, Pillar, and afterHarness variables are declared, but not initialized.
setvariable Start
...
harnessCount:
 echo * * * Label: harnessCount
 echo * * * We currently believe counter is %c
 counter sub 1
 echo * * * Now we've subtracted one and the counter is %c
 echo * * * We're about to goto harnessMana%c
 goto harnessMana%c

harnessEmergency:
 echo * * * Label: harnessEmergency
...
cleanup:
 echo * * * There's no need for this portion of the script as YASSE deletes user defined variables.
