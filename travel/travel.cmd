...
ECHO * * * Only the first 3 letters of the destination need to be input.
...
SWIMCHECK7:
pause
match GREATSURVIVAL7 Athletics:
match THE-BAR EXP HELP
...
CLIMBCheckElbain7:
pause
match SWIMCheckElbain7 Athletics:
match ELB-BAR EXP HELP
...
SWIMCheckElbain7:
pause
match GREATSURVIVALElbain7 Athletics:
match ELB-BAR EXP HELP
put experience survival 30
matchwait
...
CLIMBCheckLang7:
pause
match SWIMCheckLang7 Athletics:
match LAN-BAR EXP HELP
...
SWIMCheckLang7:
pause
match GREATSURVIVALLang7 Athletics:
match LAN-BAR EXP HELP
put experience survival 30
matchwait
...
pause
match nsundergondola Athletics:
...
ECHO * * * Southern Gondola Platform
pause
match snundergondola Athletics:
...
raven1climbcheck:
pause
match raven1groupcheck Athletics:
...
raven2climbcheck:
pause
match raven2groupcheck Athletics:
